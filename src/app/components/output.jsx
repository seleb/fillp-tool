	...
	render({
		...
		return (
			<div class="output">
				...
				<input readonly id="Hex" name="Hex" onClick={this.copy} value={`0x${sum.toString(16)}`} />
				<label htmlFor="Binary">Binary Sum: </label>
				<input readonly id="Binary" name="Binary" onClick={this.copy} value={`0b${sum.toString(2)}`} />
				<label htmlFor="DecimalSum">Decimal Sum: </label>
				<input readonly id="DecimalSum" name="DecimalSum" onClick={this.copy} value={sum < 32768 ? sum.toString(10) : 'N/A over 32768'} />
				<label htmlFor="Decimal">Decimal Addition: </label>
				<input readonly id="Decimal" name="Decimal" onClick={this.copy} value={onBits.join('+') || 0} />
				<label htmlFor="color">Color: </label>
				<input readonly id="color" name="Color" onClick={this.copy} value={coloursSum} />
